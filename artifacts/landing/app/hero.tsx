  ...
  return (
    <section style={{
      ...
      <div className="gm-hero-body" style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "0 32px", maxWidth: "1100px", width: "100%" }}>
        ...
        <div className="vh-in4 gm-hero-ctas" style={{ display: "flex", gap: "12px", marginBottom: "20px", flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <a
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: "7px", color: "#4ade80", fontSize: "14px", fontWeight: 600, textDecoration: "none", marginBottom: "48px", opacity: 0.85 }}
        >
