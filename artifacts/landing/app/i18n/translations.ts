...
const en: Translations = {
    ...
    list: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "No enquiry falls through the cracks - every conversation captured in one connected inbox",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Captures appointment requests and callback schedules automatically - zero manual entry",
  ...
  how: {
    ...
    heading: "Up and running in 2–5 days",
    ...
    steps: [
      ...
      { title: "Connect your WhatsApp Business account", description: "We guide you through linking your WhatsApp Business number to GrowthMonk via Meta's official API. Our team manages the end-to-end setup — no technical skills needed.", detail: "WhatsApp Business · Meta API · Managed setup" },
      ...
      { title: "You receive qualified leads, ready to convert", description: "Qualified leads are scheduled for a callback or appointment automatically. You open your dashboard to a list of warm, qualified prospects ready to convert.", detail: "Callback scheduling · Appointment requests · Live dashboard" },
    ],
  },
  ...
  faq: {
    ...
    items: [
      { q: "What is GrowthMonk?", a: "GrowthMonk is a business communication and lead management platform for healthcare, wellness, medspa, and service businesses. It helps businesses capture inbound enquiries from WhatsApp, qualify them using business-approved questions, route them to staff, and support appointment scheduling. GrowthMonk does not provide medical advice, diagnosis, treatment recommendations, prescriptions, emergency support, or clinical decision-making." },
      ...
      { q: "How long does setup take?", a: "Most healthcare businesses are fully set up and live within 2–5 business days of onboarding. This includes the Meta WhatsApp API connection, AI configuration, and knowledge base setup. Our team handles the process end to end — you just review and approve." },
  ...
  cta: {
    ...
    badges: ["No credit card", "2–5 day setup", "Cancel anytime", "GDPR compliant"],
  },
...
const tr: Translations = {
    ...
    list: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Randevu taleplerini ve geri arama planlamalarını otomatik olarak kaydeder – manuel giriş yok",
  ...
  how: {
    ...
    heading: "2–5 günde çalışır hale gelir",
    ...
    steps: [
      ...
      { title: "WhatsApp Business hesabınızı bağlayın", description: "WhatsApp Business numaranızı Meta'nın resmi API'si aracılığıyla GrowthMonk'a bağlama sürecinde size rehberlik ediyoruz. Kurulumun tamamını ekibimiz yönetir — teknik bilgi gerekmez.", detail: "WhatsApp Business · Meta API · Yönetilen kurulum" },
      ...
      { title: "Dönüşüme hazır nitelikli leadler alın", description: "Nitelendirilen leadler otomatik olarak geri arama veya randevu için planlanır. Panonuzu açtığınızda dönüşüme hazır ılık potansiyel müşterilerin listesini görürsünüz.", detail: "Geri arama planlaması · Randevu talepleri · Canlı panel" },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Kurulum ne kadar sürer?", a: "Çoğu sağlık işletmesi, kuruluma başladıktan sonra 2–5 iş günü içinde tam olarak kurulur ve yayına girer. Bu süreç Meta WhatsApp API bağlantısını, yapay zeka yapılandırmasını ve bilgi tabanı kurulumunu kapsar. Ekibimiz süreci başından sonuna kadar yönetir — siz yalnızca inceleyip onaylarsınız." },
  ...
  cta: {
    ...
    badges: ["Kredi kartı yok", "2–5 günlük kurulum", "İstediğinizde iptal", "GDPR uyumlu"],
  },
...
const ar: Translations = {
    ...
    list: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "لا يضيع أي استفسار – كل المحادثات في صندوق وارد موحد",
      ...
      },
      {
        ...
        bullets: [
          ...
          "يسجّل طلبات المواعيد وجداول المكالمات تلقائيًا – لا إدخال يدوي",
  ...
  how: {
    eyebrow: "كيف يعمل",
    heading: "جاهز للعمل في 2–5 أيام",
    ...
    steps: [
      ...
      { title: "ربط حساب WhatsApp Business الخاص بك", description: "نرشدك خلال ربط رقم WhatsApp Business بـ GrowthMonk عبر واجهة برمجة تطبيقات Meta الرسمية. يتولى فريقنا الإعداد الكامل من البداية إلى النهاية — لا خبرة تقنية مطلوبة.", detail: "WhatsApp Business · Meta API · إعداد متكامل" },
      ...
      { title: "تستقبل عملاء مؤهلين جاهزين للتحويل", description: "يُجدوَل للعملاء المؤهلين تلقائيًا موعد استرداد أو حجز. افتح لوحتك لتجد قائمة بعملاء دافئين جاهزين للتحويل.", detail: "جدولة المكالمات · طلبات المواعيد · لوحة مباشرة" },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "كم يستغرق الإعداد؟", a: "تكون معظم المنشآت الصحية جاهزة وتعمل بالكامل خلال 2–5 أيام عمل من بدء الانضمام. يشمل ذلك ربط واجهة برمجة تطبيقات واتساب من Meta وإعداد الذكاء الاصطناعي وقاعدة المعرفة. يتولى فريقنا العملية من البداية إلى النهاية — أنت فقط تراجع وتوافق." },
  ...
  cta: {
    ...
    badges: ["بدون بطاقة ائتمان", "إعداد في 2–5 أيام", "إلغاء في أي وقت", "متوافق مع GDPR"],
  },
