    ...
    <>
      <div style={{ position: "relative", width: "100%", height: "100dvh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", backgroundColor: "#030712", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          .hg-vid1 { animation: cf1 24s ease-in-out infinite; }
          .hg-vid2 { animation: cf2 24s ease-in-out infinite; }
          .hg-vid3 { animation: cf3 24s ease-in-out infinite; }
          .hg-1 { animation: riseG 1s cubic-bezier(0.16,1,0.3,1) 0.1s both; }
          .hg-2 { animation: riseG 1s cubic-bezier(0.16,1,0.3,1) 0.3s both; }
          .hg-3 { animation: riseG 1s cubic-bezier(0.16,1,0.3,1) 0.5s both; }
          .hg-4 { animation: riseG 1s cubic-bezier(0.16,1,0.3,1) 0.7s both; }
          .hg-5 { animation: riseG 1s cubic-bezier(0.16,1,0.3,1) 0.9s both; }
          .glow-dot { animation: glowPulse 2s ease-in-out infinite; }
        ` }} />

        {/* Crossfading video backgrounds */}
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          <video autoPlay muted loop playsInline className="hg-vid1"
          ...
          <video autoPlay muted loop playsInline className="hg-vid2"
          ...
          <video autoPlay muted loop playsInline className="hg-vid3"
            style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", mixBlendMode: "luminosity", opacity: 0 }}>
        ...
        <div style={{ position: "absolute", top: 0, width: "100%", padding: "28px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 20 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "7px 16px", borderRadius: "100px", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.25)" }}>
            <span className="glow-dot" style={{ width: "7px", height: "7px", borderRadius: "50%", backgroundColor: "#22c55e", display: "inline-block" }} />
        ...
        <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "0 24px", maxWidth: "920px", marginTop: "-40px" }}>
          ...
          <div className="hg-1" style={{ marginBottom: "28px", display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <h1 className="hg-2" style={{ fontSize: "clamp(44px,7vw,100px)", fontWeight: 900, lineHeight: 1.02, letterSpacing: "-3px", color: "white", marginBottom: "8px" }}>
            One AI. Every
          </h1>
          <h1 className="hg-2" style={{ fontSize: "clamp(44px,7vw,100px)", fontWeight: 900, lineHeight: 1.02, letterSpacing: "-3px", marginBottom: "32px" }}>
          ...
          <p className="hg-3" style={{ fontSize: "19px", lineHeight: 1.7, color: "rgba(255,255,255,0.55)", maxWidth: "540px", marginBottom: "44px", fontWeight: 400 }}>
          ...
          <div className="hg-4" style={{ display: "flex", gap: "12px", marginBottom: "52px" }}>
          ...
          <div className="hg-5" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "20px 40px", color: "rgba(255,255,255,0.38)", fontSize: "13px", fontWeight: 600 }}>
